...
import { formatDate } from '@/Components/utils/utils'; // Burada utils.js dosyasından formatDate fonksiyonunu içe aktarın
                    ...
                    <div className={styles.visitContainer}>
                        <div className={styles.row}>
                            <div className={styles.doctorInfo}>
                                ...
                                <div className={styles.info}>
                                    <h5 className={styles.doctorName}>Spezialist,{reservation.employee.name} {reservation.employee.username}</h5>
                            ...
                            <div className={styles.groupContainer}>
                                ...
                                <div className={styles.group}>
                                    <h5 className={styles.groupTitle}>
                                        {formatDate(reservation.date)} {reservation.hour}, {new Date(reservation.date).toLocaleDateString('de-DE', { weekday: 'long' })}
                                    </h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={styles.row}>
                            <div className={styles.groupContainer}>
                                ...
                                {reservation.is_online ? (
                                    ...
                                    <div className={styles.group}>
                                        <h5 className={styles.groupTitle}>Präsenztermin</h5>
                        ...
                        <div className={styles.row}>
                            <div className={styles.groupContainer}>
                                ...
                                <div className={styles.group}>
                                    <h5 className={styles.groupTitle}>Wie bereitet man sich auf ein Online-Interview vor?</h5>
                                </div>
                        ...
                        <div className={styles.row}>
                            <div className={styles.groupContainer}>
                                ...
                                <div className={styles.group}>
                                    <h5 className={styles.groupTitle}>Müssen Sie den Termin absagen?</h5>
                                </div>
