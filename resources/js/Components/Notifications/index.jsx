...
import { formatDate } from "../utils/utils"; // formatDate fonksiyonunun doğru import edildiğinden emin olun
...
const Notifications = ({ notifications }) => {
    ...
    return (
        <Dropdown>
            <Dropdown.Trigger>
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" fill="none" className="cursor-pointer">
